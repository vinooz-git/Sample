		...
		for(int j =0; j<serverList.size(); j++)
			...
			node(nodeName) 
				{		
				 ...
				 //bat label: '', script: '(robocopy C:\\PACS_build\\8_1_0\\IBM Merge PACS Server Software CD C:\\Pacs_Build\\8_1_0 /S /MT:100 /nfl /ndl > C:\\log.txt) ^& IF %ERRORLEVEL% LEQ 4 exit /B 0'
